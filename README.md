...
The implementation audit records 20 passing backend tests, successful backend smoke checks, a production frontend build, public query verification, 18 public compliance rows, three public regulation paths, and the deployed 107-chunk vector index. See [Implementation Audit](docs/IMPLEMENTATION_AUDIT.md) for the evidence and remaining pilot validation.
...
docs/                Submission assets, demo script, pitch deck, and implementation evidence
